...
const en = {
  ...
  standings: {
    ...
    noData: 'no data',
    attendanceInfo: 'Informational only — does not affect the score',
...
const bg: Strings = {
  ...
  standings: {
    ...
    avgAttendance: 'Средно присъствие',
    ...
    noData: 'няма данни',
    attendanceInfo: 'Само за информация — не влияе на резултата',
